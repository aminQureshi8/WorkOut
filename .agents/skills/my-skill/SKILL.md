...
4. **No Code Comments:** Do not write any explanatory comments, inline comments, or TODOs inside the generated TypeScript, TSX, or configuration code. The code must be clean, self-documenting, and free of comment blocks.
