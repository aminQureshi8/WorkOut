...
export default function WorkoutsManagement() {
      ...
      if (editingDay) {
        ...
        if (res.ok) {
          ...
          if (selectedDay?._id === editingDay._id) {
            setSelectedDay({ ...selectedDay, ...dayForm } as any);
          }
        }
      } else {
        const res = await fetch("/api/admin/subscription/workout-days", {
  ...
  const handleDeleteDay = async (id: string) => {
    if (
      !(await showConfirm("حذف روز تمرینی", "آیا از حذف این روز و تمامی حرکات ورزشی آن اطمینان دارید؟"))
    )
      return;
    try {
            ...
            <div className="lg:col-span-3">
              {!selectedPackage ? (
                <div className="h-64 border border-dashed border-white/10 rounded-2xl flex flex-col items-center justify-center text-white/40 text-center p-8 bg-white/5">
                  ...
                  <p className="font-semibold text-lg">برای شروع، یک پکیج را از ستون سمت راست انتخاب کنید</p>
                ...
                <div className="space-y-6">
                  ...
                  {!workoutPlan ? (
                    <div className="bg-white/5 border border-white/10 rounded-2xl p-6 text-center">
                      ...
                      <h4 className="text-white font-bold text-lg mb-2">برنامه تمرینی یافت نشد</h4>
                      <p className="text-white/60 text-sm mb-6">
                        برنامه تمرینی برای پکیج {selectedPackage.name} تعریف نشده است. لطفاً ابتدا عنوان و توضیحات را وارد کنید.
                      </p>
                      <form onSubmit={handleCreatePlan} className="max-w-xl mx-auto space-y-4 text-right">
                        <div>
                          <label className="block text-white/70 text-xs mb-2">عنوان برنامه</label>
                          <input
                            type="text"
                        ...
                        <div>
                          <label className="block text-white/70 text-xs mb-2">توضیحات کلی</label>
                          <textarea
                    ...
                    <div className="bg-white/5 border border-white/10 rounded-2xl p-6 relative">
                      {isEditingPlanInfo ? (
                        <div className="space-y-4">
                          ...
                          <div>
                            <label className="block text-white/70 text-xs mb-2">توضیحات</label>
                            <textarea
                              value={planForm.description}
                              onChange={(e) => setPlanForm({ ...planForm, description: e.target.value })}
                          ...
                          <div className="flex gap-2 justify-end">
                            ...
                            <button
                              onClick={() => {
                                setIsEditingPlanInfo(false);
                                setPlanForm({ title: workoutPlan.title, description: workoutPlan.description || "" });
                              }}
                        ...
                        <div className="flex justify-between items-start">
                          <div>
                            <h3 className="text-xl font-bold text-white mb-2">{workoutPlan.title}</h3>
                        ...
                        {showDayForm && (
                          ...
                          >
                            ...
                            <div className="flex gap-2">
                              <button
                                type="submit"
                                className="flex-1 bg-green-600 hover:bg-green-700 text-white py-1.5 rounded text-xs transition-colors"
                              >
                              ...
                              <button
                                ...
                                className="flex-1 bg-white/10 hover:bg-white/15 text-white py-1.5 rounded text-xs transition-colors"
                              >
                                انصراف
                              </button>
                            </div>
                                  ...
                                  <div className="flex gap-1" onClick={(e) => e.stopPropagation()}>
                                    <button
                                      ...
                                      className={`p-1.5 rounded transition-all ${
                                        isSelected ? "hover:bg-white/20 text-white" : "hover:bg-white/5 text-blue-400"
                                      }`}
                                    >
                                    ...
                                    <button
                                      ...
                                      className={`p-1.5 rounded transition-all ${
                                        isSelected ? "hover:bg-white/20 text-white" : "hover:bg-white/5 text-red-400"
                                      }`}
                                    >
                      ...
                      <div className="md:col-span-2 space-y-4">
                        {!selectedDay ? (
                          <div className="h-[300px] border border-dashed border-white/10 rounded-2xl flex flex-col items-center justify-center text-white/40 p-8 text-center bg-white/5">
                            ...
                            <p className="text-sm">جهت مشاهده تمرینات، یک روز را انتخاب کنید</p>
                          </div>
                        ) : (
                          <div className="space-y-4">
                            ...
                            {showExerciseForm && (
                              ...
                              >
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                  ...
                                  <div>
                                    <label className="block text-white/70 text-[10px] mb-1">تعداد تکرار (رپس)</label>
                                    <input
                                      type="text"
                                  ...
                                  <div>
                                    <label className="block text-white/70 text-[10px] mb-1">زمان استراحت (ثانیه)</label>
                                    <input
                                      type="number"
                                  ...
                                  <div>
                                    <label className="block text-white/70 text-[10px] mb-1">ترتیب نمایش (Sort Order)</label>
                                    <input
                                      type="number"
                                ...
                                <div className="flex gap-2 justify-end">
                                  ...
                                  >
                                    {editingExercise ? "بروزرسانی حرکت" : "افزودن حرکت"}
                                  </button>
                                  <button
                                    type="button"
                                    onClick={() => {
                                  ...
                                  >
                                    <div className="space-y-1">
                                      ...
                                      <div className="flex flex-wrap gap-4 text-xs text-white/60 pt-1">
                                        <span className="ss02">ست‌ها: {ex.sets}</span>
                                        <span className="ss02">تکرار: {ex.reps}</span>
          ...
          <div className="bg-gradient-to-br from-gray-950 to-gray-900 border border-white/10 rounded-2xl w-full max-w-4xl overflow-hidden flex flex-col shadow-2xl">
            ...
            <div className="aspect-video w-full bg-black relative">
              <video
                ...
                controls
                autoPlay
                poster={watchingVideo.thumbnailUrl}
