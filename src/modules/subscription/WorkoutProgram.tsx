...
export default function WorkoutProgram({ plan, days }: { plan: any; days: any }) {
  const workoutProgram = [
    ...
    },
    {
      ...
      focus: "پشت و دوسر",
      exercises: [
        { name: "ددلیفت", sets: "۴ ست", reps: "۶-۸ تکرار", rest: "۱۲۰ ثانیه" },
        {
          name: "بارفیکس",
          sets: "۴ ست",
          reps: "تا واماندگی",
    ...
    },
    {
      ...
      focus: "پا",
      exercises: [
        { name: "اسکات", sets: "۴ ست", reps: "۸-۱۲ تکرار", rest: "۱۲۰ ثانیه" },
        { name: "پرس پا", sets: "۴ ست", reps: "۱۰-۱۲ تکرار", rest: "۹۰ ثانیه" },
        { name: "لانچ", sets: "۳ ست", reps: "۱۰-۱۲ تکرار", rest: "۶۰ ثانیه" },
        {
          name: "پشت پا دستگاه",
          sets: "۴ ست",
          reps: "۱۲-۱۵ تکرار",
    ...
    {
      day: "جمعه",
      focus: "تمرین کامل بدن (Full Body)",
      exercises: [
        { name: "پرس سینه", sets: "۳ ست", reps: "۱۰ تکرار", rest: "۶۰ ثانیه" },
        { name: "پارویی", sets: "۳ ست", reps: "۱۰ تکرار", rest: "۶۰ ثانیه" },
        {
          name: "پرس سرشانه",
          sets: "۳ ست",
          reps: "۱۰ تکرار",
        ...
        { name: "اسکات", sets: "۳ ست", reps: "۱۰ تکرار", rest: "۶۰ ثانیه" },
      ],
    },
  ];
