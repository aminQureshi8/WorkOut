    ...
    <div className="rounded-2xl border border-white/10 bg-white/5 p-5 space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3 text-center">
        <div className="bg-white/5 p-3 rounded-xl border border-white/5">
          ...
          <span className="text-sm font-bold ss02 text-purple-400 mt-1 block">
            {totalExercises * 10 || 30} دقیقه
          </span>
        </div>
        <div className="bg-white/5 p-3 rounded-xl border border-white/5">
          <span className="text-[10px] text-gray-400 block">تعداد حرکات</span>
          <span className="text-sm font-bold ss02 text-pink-400 mt-1 block">
            {totalExercises} حرکت
          </span>
        </div>
      </div>
